...
_EXPORTS = {
    ...
    "format_structure_inspection": ("protcross.data.inspection", "format_structure_inspection"),
    "inspect_structure": ("protcross.data.inspection", "inspect_structure"),
    ...
    "canonicalize_parsed_structure": ("protcross.data.structure", "canonicalize_parsed_structure"),
